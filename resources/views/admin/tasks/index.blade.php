    ...
    <section role="main" class="content-body">
        ...
        <div class="card-body" style="padding:20px">
            <div class="row">
                <div class="col-sm-6">
                    <div class="mb-3">
                        <button  class="btn btn-primary" onclick="createTask()">@lang('admin.add') <i class="fas fa-plus"></i></button>
                    </div>
                </div>
            </div>
            <div id="alert-div">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> @lang('admin.tasks')</h5>
...
@push('js')
    <script type="text/javascript">
        ...
        */
        ...
        {
            let url = "{{ route('admin.tasks.edit', ['task' => 'brandId']) }}".replace('brandId', id);
        ...
        */
        function updateTask()
        {
            ...
            let url = "{{ route('admin.tasks.update', ['task' => 'brandId']) }}".replace('brandId', id);
            let data = {
                id: $("#update_id").val(),
                name: $("#name").val(),
            };
        ...
        */
        ...
        {
            let url = "{{ route('admin.tasks.destroy', ['task' => 'brandId']) }}".replace('brandId', id);
            let data = {
                name: $("#name").val(),
            };
            $.ajax({
