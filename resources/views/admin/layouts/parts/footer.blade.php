...
<script src="{{asset('admin_assets/vendor/jquery-ui/jquery-ui.js')}}"></script>
<script src="{{asset('admin_assets/vendor/jqueryui-touch-punch/jquery.ui.touch-punch.js')}}"></script>
<script src="{{asset('admin_assets/vendor/jquery-appear/jquery.appear.js')}}"></script>
<script src="{{asset('admin_assets/vendor/bootstrap-multiselect/js/bootstrap-multiselect.js')}}"></script>
<script src="{{asset('admin_assets/vendor/jquery.easy-pie-chart/jquery.easypiechart.js')}}"></script>
...
<script src="{{asset('admin_assets/vendor/select2/js/select2.js')}}"></script>
<script src="{{asset('admin_assets/vendor/datatables/media/js/jquery.dataTables.min.js')}}"></script>
<script src="{{asset('admin_assets/vendor/datatables/media/js/dataTables.bootstrap5.min.js')}}"></script>
...
<!-- Examples -->
<script src="{{asset('admin_assets/js/examples/examples.dashboard.js')}}"></script>
<script src="{{asset('admin_assets/js/examples/examples.datatables.ajax.js')}}"></script>

<!-- Specific Page Vendor -->
<script src="{{asset('admin_assets/vendor/autosize/autosize.js')}}"></script>
